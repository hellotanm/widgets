...
import we2009.flowlayout.FlowLayout;
...
public class FlowLayoutSample extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_add_random:
                ...
                final ViewGroup.MarginLayoutParams lp = new ViewGroup.MarginLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ranHeight));
                ...
                tv.setLines(1);
                tv.setBackgroundResource(R.drawable.flow_layout_bg_tag);
